...
class Client(models.Model):
    ...
    num_client = models.BigIntegerField(blank=True, null=True)
    ...
    adresse_client = models.TextField(max_length=128, blank=False)
    pays_client = models.CharField(max_length=30, blank=False, default="Madagascar")
    profession_client = models.CharField(max_length=50, blank=True, null=True, default=None)
    nb_personne_menage = models.CharField(max_length=30, blank=True, null=True, default=None)
